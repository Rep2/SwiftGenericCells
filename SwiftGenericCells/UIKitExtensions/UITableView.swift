...
extension UITableView {
     ...
     */
    public func register<T: UITableViewCell>(cell: T.Type, reusableCellSource: ViewSource) {
...
extension UITableView {
     ...
     */
    func dequeueAndPresent<Presenter: ViewModelPresenter>(presentableViewModel: PresentableViewModel<Presenter>, for indexPath: IndexPath) -> Presenter where Presenter: UITableViewCell {
