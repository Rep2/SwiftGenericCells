...
extension TitleTableViewCellViewModel: DequeuableTableViewCellViewModel {
    public typealias TableViewCell = TitleTableViewCell
}

public class TitleTableViewCell: UITableViewCell, PresentingTableViewCell {
